...
public abstract class AppWorkspaceComponent {
     ...
     * the controls for editing work.
     *
     * @param appPane The pane that contains all the controls in the entire
     * application, including the file toolbar controls, which this framework
     * manages, as well as the customly provided workspace, which would be
     ...
     *
     * @param initWorkspace The workspace to set as the user interface's
     * workspace.
     */
    ...
    /**
     * This function must be defined in the actual workspace component class and
    ...
    /**
     * This function must be defined in the actual workspace component class and
     * should be called after data has been loaded and the workspace must use it
