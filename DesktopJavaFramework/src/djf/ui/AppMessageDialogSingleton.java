...
/**
 * This class serves to present custom text messages to the user when events
 * occur. Note that it always provides the same controls, a label with a
 * message, and a single Ok button.
 *
