...
/**
 * The InvalidXMLFileFormatException is a checked exception that represents the
 * occasion where an XML document does not validate against its schema (XSD).
 *
...
public class InvalidXMLFileFormatException extends Exception {
    ...
    /**
     * Constructor that records which xml file produced the error, but not the
     * schema.
     *
     ...
     *
     * @return This message will be useful for describing where validation
     * failed.
     */
    @Override
